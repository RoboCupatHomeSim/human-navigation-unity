...
{
	public class HumanNaviModeratorForPractice : MonoBehaviour, ITimeIsUpHandler, IStartTrialHandler, IGoToNextTrialHandler, IReceiveHumanNaviMsgHandler//, IGiveUpHandler
	{
		...
		private void ResetFlags()
		{
			...
			this.isFirstInstructionFinished = false;
		}
		...
		{
			this.interruptedReason = HumanNaviModeratorForPractice.ReasonTimeIsUp;
		}
		...
		public void OnGiveUp()
		{
			if (this.isDuringTrial)
			{
				this.interruptedReason = HumanNaviModeratorForPractice.ReasonGiveUp;
