...
{
	public class HumanNaviPlacementCheckerForPractice : MonoBehaviour
	{
		...
		private HumanNaviModeratorForPractice moderator; // TODO: should be modified
		...
		void Start ()
		{
			...
			this.moderator = GameObject.Find("Moderator").GetComponent<HumanNaviModeratorForPractice>(); 
		}
